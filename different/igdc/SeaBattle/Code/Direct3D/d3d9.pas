...
{*                                                                            *}
{*  DirectX 9.0 February 2005 Delphi/FreePascal adaptation by Alexey Barkovoy *}
...
{*                                                                            *}
{*----------------------------------------------------------------------------*}
{*  $Id: Direct3D9.pas,v 1.8 2005/02/13 16:35:56 clootie Exp $ }
{******************************************************************************}
{                                                                              }
...
type
  ...
  D3DCOLOR = d3dtypes.D3DCOLOR;
  {$EXTERNALSYM D3DCOLOR}
  TD3DColor = d3dtypes.TD3DColor;
...
type
  float      = single;
  _D3DVECTOR = d3dtypes._D3DVECTOR;
  {$EXTERNALSYM _D3DVECTOR}
  D3DVECTOR = d3dtypes.D3DVECTOR;
  {$EXTERNALSYM D3DVECTOR}
  TD3DVector = d3dtypes.TD3DVector;
  PD3DVector = d3dtypes.PD3DVector;
...
//---------------------------------------------------------------------
  D3DSTREAMSOURCE_INDEXEDDATA  = LongWord(1 shr 30);
  {$EXTERNALSYM D3DSTREAMSOURCE_INDEXEDDATA}
  D3DSTREAMSOURCE_INSTANCEDATA = LongWord(2 shr 30);
