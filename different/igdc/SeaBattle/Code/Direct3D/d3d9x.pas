...
{*                                                                            *}
{*  Direct3DX 9.0 February 2005 Delphi adaptation by Alexey Barkovoy          *}
...
{*                                                                            *}
{*----------------------------------------------------------------------------*}
{*  $Id: D3DX9.par,v 1.16 2005/02/12 22:49:57 clootie Exp $ }
{******************************************************************************}
{                                                                              }
...
uses
  Windows, ActiveX,
  SysUtils, D3D9, D3DTypes;

const
  //////////// DLL export definitions ///////////////////////////////////////
  d3dx9MicrosoftDLL = 'Data\dll\DirectX.dll';
  d3dx9MicrosoftDebugDLL = 'd3dx9d_24.dll';
