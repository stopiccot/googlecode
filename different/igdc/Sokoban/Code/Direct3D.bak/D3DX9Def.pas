...
{*                                                                            *}
{*  Direct3DX 9.0 April 2006 Delphi adaptation by Alexey Barkovoy             *}
...
{*                                                                            *}
{*----------------------------------------------------------------------------*}
{*  $Id: D3DX9.par,v 1.25 2006/04/23 18:55:22 clootie Exp $ }
{******************************************************************************}
{                                                                              }
...
uses
  Windows, ActiveX,
  SysUtils, D3D9, DXTypes;

const
  //////////// DLL export definitions ///////////////////////////////////////
  d3dx9MicrosoftDLL = 'Data\dll\d3dx9.dll';
  d3dx9MicrosoftDebugDLL = 'd3dx9.dll';
