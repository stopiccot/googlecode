...
// Desc: “ак как dll-ка Direct 3D eXtension Library, в каждом updat'е DirectX
//       мен€ет название, а "таскать" с собой лишних 2 Mb ой как не хочетьс€, то
//       динамически устанавливаем св€зь с той версией dll-ки, которую найдЄм :)
//==============================================================================
  function DynamicallyLinkD3DX9: Boolean;
